        ...
        <div className="box">
          {
            ...
            <Aux>
              ...
              }
              {
                ...
                :
                <h1 className="subtitle is-5 has-text-centered">
                  Respondiste correctamente {props.correctAnswers} preguntas de {props.totalQuestions}
                </h1>
              }
          ...
          
          {
            props.error && (
      		...
      		{
      			!props.gameSaved && <GameFinishedForm submitHandler={props.submitHandler} loading={props.loading} />
      		}
      		{
      			props.gameSaved && <Aux>
