...
const QuestionSchema = Yup.object().shape({
	...
	.oneOf(['easy', 'medium', 'hard'], 'Debes elegir una dificultad'),
								...
								<Form>
									...
									<div className="field is-horizontal">
										<div className="field-body">
											...
											name="options"
											render={() => (
													values.options.map((option, index) => index < 2 && (
															<div className="field" key={index}>
																...
																<div className="control">
																	...
																	value={option.text}
																	className={["input",
																		((errors.options || [])[index] || {}).text && ((touched.options || [])[index] || {}).text && "is-danger",
																		!((errors.options || [])[index] || {}).text && ((touched.options || [])[index] || {}).text && "is-success"
																	].join(' ')}
									...
									<div className="field is-horizontal">
										<div className="field-body">
											<div className="field">
												...
												<div className="control">
													<div className={["select",
														errors.difficulty && touched.difficulty && "is-danger",
														!errors.difficulty && touched.difficulty && "is-success"
													].join(' ')}>
														<Field 
														name="difficulty"
														component="select"
											...
											<div className="field">
												...
												<div className="control">
													<div className={["select",
															errors.correct_answer && touched.correct_answer && "is-danger",
															!errors.correct_answer && touched.correct_answer && "is-success"
														].join(' ')}>
														<Field 
														name="correct_answer"
														component="select"
									...
									<div className="field">
										...
										<div className="control">
											...
											placeholder="https://wikipedia.com/trivia"
											disabled={props.loading}	/>
										</div>
									...
									<div className="field">
										...
										<div className="control">
											...
											component="textarea"
											className={["textarea",
												errors.did_you_know && touched.did_you_know && "is-danger",
												!errors.did_you_know && touched.did_you_know && "is-success"
											].join(' ')}
									...
									<div className="buttons">
										<button type="submit" className={["button", "is-info", props.loading ? "is-loading" : null].join(' ')} disabled={props.loadingCategories}>Enviar</button>
										<button type="button" onClick={() => {resetForm(QuestionInitialValues)}} className="button" disabled={props.loading}>Limpiar Formulario</button>
									</div>
								</Form>
								)
						}
